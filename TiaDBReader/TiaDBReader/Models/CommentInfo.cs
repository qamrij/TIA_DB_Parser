...
namespace TiaDBReader.Models
{
    public class CommentInfo
    {
        ...
        */
        ...
        public static string IsLogged { get; } = "VERO";
        public static string IsPrinted { get; } = "VERO";
        public static string HasAcknowledgeTag { get; } = "FALSO";
        ...
        public static string SingleInstance { get; } = "FALSO";
        public static string NegativeLogic { get; } = "FALSO";
        public static string TagOPC { get; } = "FALSO";
